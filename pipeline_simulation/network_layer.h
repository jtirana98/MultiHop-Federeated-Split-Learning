...
class network_layer {
 public:
    ...
    my_rpi(1)
    {
        ...
        rooting_table.insert({2, std::pair<std::string, int>("10.96.12.130", 8083)});
        rooting_table.insert({3, std::pair<std::string, int>("10.96.12.130", 8084)});
        rooting_table.insert({4, std::pair<std::string, int>("10.96.12.130", 8085)});
        rooting_table.insert({5, std::pair<std::string, int>("10.96.12.130", 8086)});
    }
