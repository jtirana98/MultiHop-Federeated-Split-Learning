...
class network_layer {
 public:
    ...
    logger_thread(&logger::logger_, &mylogger) 
    {
        ...
        rooting_table.insert({3, std::pair<std::string, int>("10.96.12.132", 8084)});
        rooting_table.insert({4, std::pair<std::string, int>("10.96.12.133", 8085)});
        rooting_table.insert({5, std::pair<std::string, int>("10.96.12.136", 8086)});
    }
