...
def get_res(data_owners =300):
    ...
    for num_c in num_of_compute_nodes:
        ...
        for d in data_owners: # ready to compute cost
            ...
            first_batch = all_hops([data_owners_computation[0]], 0) + data_owners_computation[0].send_a + all_hops(compute_nodes_computation, 0) + all_hops(compute_nodes_computation, 1)
            last_batch =  all_hops([data_owners_computation[1]], 0)+ all_hops([data_owners_computation[1]], 1) + compute_nodes_computation[-1].send_g
